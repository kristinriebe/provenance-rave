"""
Django settings for provsite project.
...
SECRET_KEY = 'nd&jm&88(k48@x+h^q)1g+ey=d_pxmby7=h)8o%xjb#dua&cy2'
...
WSGI_APPLICATION = 'provsite.wsgi.application'
